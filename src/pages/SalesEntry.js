    ...
    <div className="max-w-7xl mx-auto py-6 px-4">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-6">
        ...
        <form onSubmit={handleSingleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          />
          <button type="submit" className="md:col-span-2 bg-stockly-green text-slate-900 p-2 rounded hover:bg-emerald-400 transition font-semibold">Add Sale</button>
        </form>
      </div>
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <form onSubmit={handleBulkSubmit}>
          ...
          <button type="submit" className="bg-stockly-green text-slate-900 p-2 rounded hover:bg-emerald-400 transition font-semibold">Upload and Process</button>
        </form>
      </div>
    </div>
  );
