  ...
  return (
    <div className="max-w-md mx-auto py-6 px-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button type="submit" className="w-full bg-stockly-green text-slate-900 p-3 rounded-lg hover:bg-stockly-400 transition font-semibold shadow-lg hover:shadow-xl">Predict</button>
      </form>
      {prediction && <p className="mt-4 text-stockly-600 font-semibold">Predicted Quantity: {prediction}</p>}
